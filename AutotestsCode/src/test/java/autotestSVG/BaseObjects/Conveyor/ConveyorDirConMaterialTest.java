...
public class ConveyorDirConMaterialTest {
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Шнек, прямая конвертация, проверка динамизации параметра [Наличие материала] шнеков)")
    ...
    public void screw(){
        ...
        tester.check.screenshotBasedTest(driver, PATH, "screw_material", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Шнек изометрия, прямая конвертация, проверка динамизации параметра [Наличие материала] шнеков)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Конвейеры и шнеки")
    ...
    public void screwIsometriya(){
        ...
        local.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "screwIsometriya_material", XPath);
    }
}
