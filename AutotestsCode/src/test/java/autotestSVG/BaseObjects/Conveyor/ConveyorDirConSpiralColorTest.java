...
public class ConveyorDirConSpiralColorTest {
    ...
    public static void oneTimeSetup() {
        ...
        InsatWebUITools tester = new InsatWebUITools();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@data-control-id = '112492']")));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-control-id = '112492']")));
        tester.set.colorButton(driver, "//*[@data-control-id = '112492']");
    }
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Шнек, прямая конвертация, проверка динамизации параметра [Цвет спирали] шнеков)")
    ...
    public void screw(){
        ...
        tester.check.screenshotBasedTest(driver, PATH, "screw_sriralColor", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Шнек изометрия, прямая конвертация, проверка динамизации параметра [Цвет спирали] шнеков)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Конвейеры и шнеки")
    ...
    public void screwIsometriya(){
        ...
        local.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "screwIsometriya_sriralColor", XPath);
    }
}
