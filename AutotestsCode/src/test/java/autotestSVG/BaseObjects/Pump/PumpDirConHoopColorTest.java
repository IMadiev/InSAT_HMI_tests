...
public class PumpDirConHoopColorTest {
    ...
    public static void oneTimeSetup() {
        ...
        InsatWebUITools tester = new InsatWebUITools();
        tester.action.wait(driver, "//*[@data-control-id = '65059']");
        tester.set.colorButton(driver, "//*[@data-control-id = '65059']");
    }
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос вертикальный, прямая конвертация, проверка динамизации параметра [Цвет обода])")
    ...
    public void nasosVerticalniy(){
        ...
        tester.check.screenshotBasedTest(driver, PATH, "nasosVerticalniy_hoopColor", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос улитка вертикальный, прямая конвертация, проверка динамизации параметра [Цвет обода])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void nasosUlitkaVerticalniy(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "nasosUlitkaVerticalniy_hoopColor", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос горизонтальный, прямая конвертация, проверка динамизации параметра [Цвет обода])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void nasosGorizontalniy(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "nasosGorizontalniy_hoopColor", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Шестеренчатый насос, прямая конвертация, проверка динамизации параметра [Цвет обода])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void shesterenchatiyNasos(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "shesterenchatiyNasos_hoopColor", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Шестеренчатый насос 2, прямая конвертация, проверка динамизации параметра [Цвет обода])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void shesterenchatiyNasos2(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "shesterenchatiyNasos2_hoopColor", XPath);
    }
}
