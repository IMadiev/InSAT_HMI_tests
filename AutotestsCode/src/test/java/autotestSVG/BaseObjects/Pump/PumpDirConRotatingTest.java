...
public class PumpDirConRotatingTest {
    ...
    public static void oneTimeSetup() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@data-control-id = '64892']")));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-control-id = '64892']")));
        driver.findElement(By.xpath("//*[@data-control-id = '64892']")).click();
    }
    ...
    public void nasosVerticalniy(){
        ...
        local.checkSVGclass(driver, XPath, "Start", "Параметр [Вращение] не сработал");
    }
