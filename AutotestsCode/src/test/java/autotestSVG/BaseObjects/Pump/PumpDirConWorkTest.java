...
public class PumpDirConWorkTest {
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос вертикальный, прямая конвертация, проверка динамизации параметра [Работа])")
    ...
    public void nasosVerticalniy(){
        ...
        tester.check.screenshotBasedTest(driver, PATH, "nasosVerticalniy_work", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос улитка вертикальный, прямая конвертация, проверка динамизации параметра [Работа])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void nasosUlitkaVerticalniy(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "nasosUlitkaVerticalniy_work", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос горизонтальный, прямая конвертация, проверка динамизации параметра [Работа])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void nasosGorizontalniy(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "nasosGorizontalniy_work", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Насос профиль, прямая конвертация, проверка динамизации параметра [Работа])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void nasosProfil(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "nasosProfil_work", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Шестеренчатый насос, прямая конвертация, проверка динамизации параметра [Работа])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void shesterenchatiyNasos(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "shesterenchatiyNasos_work", XPath);
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Шестеренчатый насос 2, прямая конвертация, проверка динамизации параметра [Работа])")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [BaseObjects]")
    @Feature(value = "Насосы")
    ...
    public void shesterenchatiyNasos2(){
        ...
        tester.action.waitSVG(driver, XPath);
        tester.check.screenshotBasedTest(driver, PATH, "shesterenchatiyNasos2_work", XPath);
    }
}
