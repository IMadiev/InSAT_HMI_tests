...
public class IndicatorsDirConBodyTest {
    ...
    public static void oneTimeSetup() {
        ...
        InsatWebUITools tester = new InsatWebUITools();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@data-control-id = '132014']")));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-control-id = '132014']")));
        tester.set.colorButton(driver, "//*[@data-control-id = '132014']");
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    ...
    public void indicator(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator_body", "//*[@data-control-id = '131716']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 1, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator1(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator1_body", "//*[@data-control-id = '131728']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 2, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator2(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator2_body", "//*[@data-control-id = '131740']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 3, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator3(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator3_body", "//*[@data-control-id = '131752']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 4, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator4(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator4_body", "//*[@data-control-id = '131764']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка энергосберегающая, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochkaEnergosberegayuschaya(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochkaEnergosberegayuschaya_body", "//*[@data-control-id = '131788']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka_body", "//*[@data-control-id = '131776']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка 2, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka2(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka2_body", "//*[@data-control-id = '131802']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка 3, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka3(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka3_body", "//*[@data-control-id = '131816']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка 4, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka4(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka4_body", "//*[@data-control-id = '131828']");
    }


    @Description("Сравнение скриншота актуальной страницы с эталоном (Светофор пешеходный, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void svetoforPeshehodniy(){
        tester.check.screenshotBasedTest(driver, PATH, "svetoforPeshehodniy_body", "//*[@data-control-id = '131842']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Светофор, прямая конвертация, проверка корректности цвета корпуса после динамизации)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void svetofor(){
        tester.check.screenshotBasedTest(driver, PATH, "svetofor_body", "//*[@data-control-id = '131854']");
    }
}
