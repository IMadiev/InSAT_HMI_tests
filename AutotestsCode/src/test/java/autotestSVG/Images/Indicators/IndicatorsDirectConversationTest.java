...
public class IndicatorsDirectConversationTest {
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор, прямая конвертация, проверка корректности начального отображения)")
    ...
    public void indicator(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator", "//*[@data-control-id = '131716']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 1, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator1(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator1", "//*[@data-control-id = '131728']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 2, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator2(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator2", "//*[@data-control-id = '131740']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 3, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator3(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator3", "//*[@data-control-id = '131752']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Индикатор 4, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void indicator4(){
        tester.check.screenshotBasedTest(driver, PATH, "indicator4", "//*[@data-control-id = '131764']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка энергосберегающая, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochkaEnergosberegayuschaya(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochkaEnergosberegayuschaya", "//*[@data-control-id = '131788']");
    }
    ...
    public void lampochka(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka", "//*[@data-control-id = '131776']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка 2, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka2(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka2", "//*[@data-control-id = '131802']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка 3, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka3(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka3", "//*[@data-control-id = '131816']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Лампочка 4, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void lampochka4(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka4", "//*[@data-control-id = '131828']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Снежинка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void snezhinka(){
        tester.check.screenshotBasedTest(driver, PATH, "snezhinka", "//*[@data-control-id = '131878']");
    }
    ...
    @Test
    public void solntse(){
        tester.check.screenshotBasedTest(driver, PATH, "solntse", "//*[@data-control-id = '131902']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Солнце снежинка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void solntseSnezhinka(){
        tester.check.screenshotBasedTest(driver, PATH, "solntseSnezhinka", "//*[@data-control-id = '131890']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Светофор пешеходный, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Индикаторы")
    ...
    public void svetoforPeshehodniy(){
        tester.check.screenshotBasedTest(driver, PATH, "svetoforPeshehodniy", "//*[@data-control-id = '131842']");
    }
    ...
    public void svetofor(){
        tester.check.screenshotBasedTest(driver, PATH, "svetofor", "//*[@data-control-id = '131854']");
    }
}
