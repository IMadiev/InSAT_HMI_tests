...
public class OilProductionDirectConversationTest {
    ...
    @Test
    public void barzha(){
        tester.check.screenshotBasedTest(driver, PATH, "barzha", "//*[@data-control-id = '245377']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Бензовоз, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void benzovoz(){
        tester.check.screenshotBasedTest(driver, PATH, "benzovoz", "//*[@data-control-id = '245391']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Бочка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    @Story(value = "Бочка")
    ...
    @Test
    public void bochka(){
        tester.check.screenshotBasedTest(driver, PATH, "bochka", "//*[@data-control-id = '245405']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Вышка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    @Story(value = "Вышка")
    ...
    @Test
    public void vishka(){
        tester.check.screenshotBasedTest(driver, PATH, "vishka", "//*[@data-control-id = '245419']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Вышки, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    @Story(value = "Вышки")
    ...
    @Test
    public void vishki(){
        tester.check.screenshotBasedTest(driver, PATH, "vishki", "//*[@data-control-id = '245433']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Задвижка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void zadvizhka(){
        tester.check.screenshotBasedTest(driver, PATH, "zadvizhka", "//*[@data-control-id = '245447']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Источник, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void istochnik(){
        tester.check.screenshotBasedTest(driver, PATH, "istochnik", "//*[@data-control-id = '245461']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Канистра, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void kanistra(){
        tester.check.screenshotBasedTest(driver, PATH, "kanistra", "//*[@data-control-id = '245475']");
    }
    ...
    @Test
    public void kaplya(){
        tester.check.screenshotBasedTest(driver, PATH, "kaplya", "//*[@data-control-id = '245489']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Колонка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    @Story(value = "Колонка")
    ...
    @Test
    public void kolonka(){
        tester.check.screenshotBasedTest(driver, PATH, "kolonka", "//*[@data-control-id = '245504']");
    }
    ...
    @Test
    public void nasos(){
        tester.check.screenshotBasedTest(driver, PATH, "nasos", "//*[@data-control-id = '245518']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Пистолет, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void pistolet(){
        tester.check.screenshotBasedTest(driver, PATH, "pistolet", "//*[@data-control-id = '245532']");
    }
    ...
    public void rabochiy(){
        tester.check.screenshotBasedTest(driver, PATH, "rabochiy", "//*[@data-control-id = '245546']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Резервуар, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void reservoir(){
        tester.check.screenshotBasedTest(driver, PATH, "reservoir", "//*[@data-control-id = '245560']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Центр нефтяной, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Images]")
    @Feature(value = "Нефтедобыча")
    ...
    public void centrNeftyanoy(){
        tester.check.screenshotBasedTest(driver, PATH, "centrNeftyanoy", "//*[@data-control-id = '245574']");
    }
    ...
    public void cisterna(){
        tester.check.screenshotBasedTest(driver, PATH, "cisterna", "//*[@data-control-id = '245588']");
    }
}
