...
public class ElectricityDirectConversationTest {
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Вольт, прямая конвертация, проверка корректности начального отображения)")
    ...
    @Test
    public void volt(){
        tester.check.screenshotBasedTest(driver, PATH, "volt", "//*[@data-control-id = '189138']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Дом в сети, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void domVSeti(){
        tester.check.screenshotBasedTest(driver, PATH, "domVSeti", "//*[@data-control-id = '189150']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Дом с вышкой, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void domSVishkoy(){
        tester.check.screenshotBasedTest(driver, PATH, "domSVishkoy", "//*[@data-control-id = '189162']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Измерительный прибор, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void izmeritelniyPribor(){
        tester.check.screenshotBasedTest(driver, PATH, "izmeritelniyPribor", "//*[@data-control-id = '189174']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Измерительный прибор 2, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void izmeritelniyPribor2(){
        tester.check.screenshotBasedTest(driver, PATH, "izmeritelniyPribor2", "//*[@data-control-id = '189186']");
    }
    ...
    public void instrumenti(){
        tester.check.screenshotBasedTest(driver, PATH, "instrumenti", "//*[@data-control-id = '189198']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Контакты, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void kontakti(){
        tester.check.screenshotBasedTest(driver, PATH, "kontakti", "//*[@data-control-id = '189210']");
    }
    ...
    public void lampochka(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochka", "//*[@data-control-id = '189222']");
    }
    ...
    public void lampochki(){
        tester.check.screenshotBasedTest(driver, PATH, "lampochki", "//*[@data-control-id = '189234']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Опасность поражения током, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void opasnostPorazheniyaTokom(){
        tester.check.screenshotBasedTest(driver, PATH, "opasnostPorazheniyaTokom", "//*[@data-control-id = '189246']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Поражение током, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void porazheniyeTokom(){
        tester.check.screenshotBasedTest(driver, PATH, "porazheniyeTokom", "//*[@data-control-id = '189260']");
    }
    ...
    @Test
    public void rozetka(){
        tester.check.screenshotBasedTest(driver, PATH, "rozetka", "//*[@data-control-id = '189272']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Счетчик, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    @Story(value = "Счетчик")
    ...
    public void schetchik(){
        tester.check.screenshotBasedTest(driver, PATH, "schetchik", "//*[@data-control-id = '189284']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Счетчик 2, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void schetchik2(){
        tester.check.screenshotBasedTest(driver, PATH, "schetchik2", "//*[@data-control-id = '189296']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Электрик, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void electrik(){
        tester.check.screenshotBasedTest(driver, PATH, "electrik", "//*[@data-control-id = '189308']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Электрическая вилка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Электричество")
    ...
    public void electricheskayaVilka(){
        tester.check.screenshotBasedTest(driver, PATH, "electricheskayaVilka", "//*[@data-control-id = '189320']");
    }
}
