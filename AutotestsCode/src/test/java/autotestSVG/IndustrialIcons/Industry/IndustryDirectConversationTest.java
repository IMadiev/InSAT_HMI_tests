...
public class IndustryDirectConversationTest {
    ...
    @Description("Сравнение скриншота актуальной страницы с эталоном (Баллон, прямая конвертация, проверка корректности начального отображения)")
    ...
    @Test
    public void ballon(){
        tester.check.screenshotBasedTest(driver, PATH, "ballon", "//*[@data-control-id = '186340']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Баллоны, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Промышленность")
    @Story(value = "Баллоны")
    ...
    @Test
    public void balloni(){
        tester.check.screenshotBasedTest(driver, PATH, "balloni", "//*[@data-control-id = '186354']");
    }
    ...
    @Test
    public void barzha(){
        tester.check.screenshotBasedTest(driver, PATH, "barzha", "//*[@data-control-id = '186368']");
    }
    ...
    public void benzovoz(){
        tester.check.screenshotBasedTest(driver, PATH, "benzovoz", "//*[@data-control-id = '186382']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Вентиль, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Промышленность")
    @Story(value = "Вентиль")
    ...
    @Test
    public void ventil(){
        tester.check.screenshotBasedTest(driver, PATH, "ventil", "//*[@data-control-id = '186396']");
    }
    ...
    @Test
    public void vishka(){
        tester.check.screenshotBasedTest(driver, PATH, "vishka", "//*[@data-control-id = '186410']");
    }
    ...
    @Test
    public void kolonka(){
        tester.check.screenshotBasedTest(driver, PATH, "kolonka", "//*[@data-control-id = '186424']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Молекула, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Промышленность")
    ...
    public void molecula(){
        tester.check.screenshotBasedTest(driver, PATH, "molecula", "//*[@data-control-id = '186438']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Нефтевышка, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Промышленность")
    ...
    public void neftevishka(){
        tester.check.screenshotBasedTest(driver, PATH, "neftevishka", "//*[@data-control-id = '186452']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Нефтехранилище, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Промышленность")
    ...
    public void neftehranische(){
        tester.check.screenshotBasedTest(driver, PATH, "neftehranische", "//*[@data-control-id = '186466']");
    }

    @Description("Сравнение скриншота актуальной страницы с эталоном (Огонь, прямая конвертация, проверка корректности начального отображения)")
    @Links(value = {@Link(name = "TestProject", url = TPROJECT_LINK), @Link(name = "Rizzoma", url = RIZZOMA_LINK)})
    @Epic(value = "Библиотека [Industrial Icons]")
    @Feature(value = "Промышленность")
    @Story(value = "Огонь")
    ...
    @Test
    public void ogon(){
        tester.check.screenshotBasedTest(driver, PATH, "ogon", "//*[@data-control-id = '186480']");
    }
    ...
    public void cisterna(){
        tester.check.screenshotBasedTest(driver, PATH, "cisterna", "//*[@data-control-id = '186494']");
    }
}
