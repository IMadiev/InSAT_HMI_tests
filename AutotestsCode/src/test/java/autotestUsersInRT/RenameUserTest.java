...
public class RenameUserTest {
    ...
    public static void afterAll(){
        ...
        local.deleteTrash(driver, "Temp1");
    }

    @Description("Проверка переименования пользователя")
    ...
    @Story(value = "Переименовать пользователя")
    ...
    public void renameUser(){
        ...
        local.renameUser(driver, "Temp", "Temp1", recorder);
        tearDown();
        setup();
        local.checkUserExist(driver, "Temp1", "Temp", "Разрешить", recorder);
    }
}
